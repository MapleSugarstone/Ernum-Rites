...
public static class Bot
{
    ...
    private static GameState AlphaStrike(GameState state, int me, BotWeights w)
    {
    ...
    private static double WithFollowUp(GameState after, int me, BotWeights w, double flat)
    {
